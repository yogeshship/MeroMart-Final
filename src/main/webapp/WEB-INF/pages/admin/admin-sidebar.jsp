...
<aside class="admin-sidebar">
    ...
    <a class="brand" href="<c:url value='/admindashboard'/>">
        <img class="brand-logo"
             src="<c:url value='/assets/images/logo/logo.png?v=20260501-3'/>"
             alt="Mero Mart Nepal">
    </a>
    ...
    <nav class="sidebar-nav">
        ...
        <!-- Manage Products -->
        <a class="nav-link ${activePage eq 'products' ? 'is-active' : ''}"
           href="<c:url value='/manageproducts'/>">
            <span class="nav-icon" aria-hidden="true">
                <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        <!-- Add Product -->
        <a class="nav-link ${activePage eq 'add-product' ? 'is-active' : ''}"
           href="<c:url value='/addproduct'/>">
            <span class="nav-icon" aria-hidden="true">
        ...
        <!-- Manage Users -->
        <a class="nav-link ${activePage eq 'users' ? 'is-active' : ''}"
        ...
        <!-- Categories -->
        <a class="nav-link ${activePage eq 'categories' ? 'is-active' : ''}"
        ...
        <!-- Orders -->
        <a class="nav-link ${activePage eq 'orders' ? 'is-active' : ''}"
           href="<c:url value='/manageorder'/>">
            <span class="nav-icon" aria-hidden="true">
                <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        <!-- Contact Messages -->
        <a class="nav-link ${activePage eq 'contacts' ? 'is-active' : ''}"
           href="<c:url value='/admin/contacts'/>">
            <span class="nav-icon" aria-hidden="true">
                <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="sidebar-bottom">
        ...
        <nav class="sidebar-nav sidebar-nav--bottom" aria-label="Account">
            ...
            <!-- Settings/Profile -->
            <a class="nav-link ${activePage eq 'settings' ? 'is-active' : ''}"
