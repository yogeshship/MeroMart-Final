        ...
        <main class="admin-main admin-main--dashboard">
                    ...
                    <article class="stat-card">
                        ...
                        <div class="stat-copy">
                            ...
                            <c:if test="${not empty stat.trend}">
                                <span class="stat-trend ${stat.trendType eq 'positive' ? 'positive' : 'neutral'}">${stat.trend}</span>
                            </c:if>
                            <c:if test="${not empty stat.cta}">
                    <a class="inline-link" href="<c:url value='/manageproducts'/>">${stat.cta}</a>
                            </c:if>
                        </div>
                    </article>
                </c:forEach>
                    ...
                    <div class="sales-layout">
                        ...
                        <div class="chart-card">
                            ...
                            <svg class="sales-chart" viewBox="0 0 520 250" preserveAspectRatio="none" aria-label="Sales chart">
                                ...
                                <path d="M20 195 L100 140 L180 78 L260 145 L340 104 L420 118 L500 28 L500 220 L20 220 Z" fill="url(#chart-fill)"></path>
                                <polyline points="20,195 100,140 180,78 260,145 340,104 420,118 500,28" fill="none" stroke="#0d8b61" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></polyline>
            ...
            <section class="dashboard-bottom">
                <article class="panel stock-panel">
                    ...
                    <a class="panel-button" href="<c:url value='/manageproducts'/>">View Stock Report</a>
                </article>
                ...
                <article class="panel activity-panel">
                    ...
                    <a class="panel-button" href="<c:url value='/manageorder'/>">View All Activity</a>
                </article>
                ...
                <article class="panel product-table-panel">
                    <div class="panel-head">
                        ...
                        <a class="solid-button small" href="<c:url value='/addproduct'/>">+ Add Product</a>
                    </div>
                            ...
                            <tbody>
                                <c:forEach var="product" items="${recentProducts}">
                                    <tr>
                                        ...
                                        <td>${product.price}</td>
                                        <td>${product.stock}</td>
                                        <td><span class="status-pill ${product.statusClass}">${product.status}</span></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
                    </div>
                    <a class="panel-button" href="<c:url value='/manageproducts'/>">View All Products</a>
                </article>
            </section>
        </main>
    </div>
